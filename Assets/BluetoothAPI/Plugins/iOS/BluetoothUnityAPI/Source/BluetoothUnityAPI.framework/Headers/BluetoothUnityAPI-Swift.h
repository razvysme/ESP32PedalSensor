...
- (CBCharacteristic * _Nullable)getCharacteristic SWIFT_WARN_UNUSED_RESULT;
...
- (BOOL)sendDataWithData:(NSArray<NSNumber *> * _Nonnull)data error:(NSError * _Nullable * _Nullable)error;
- (void)Disconnect;
...
- (void)subscribe:(BluetoothHelperService * _Nonnull)service;
...
- (void)addCharacteristicToService:(NSString * _Nonnull)characteristic :(NSString * _Nonnull)service;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
